...
Новые узлы могут быть добавлены в любой момент, будь это оконечные пользовательские устройства или промежуточная инфраструктура, без ухудшения функциональности или производительности сети вцелом. 
